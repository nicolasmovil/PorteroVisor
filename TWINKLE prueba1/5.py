...
while True:  # Inicia un bucle infinito
    ...
    subprocess.call(["expect", "-c", 'spawn twinkle-console; sleep 3; send "call 101\r"; sleep 30; send "bye\r"; exit'])
    print("La aplicación twinkle-console se ha cerrado.")

    # Espera 1 segundo para evitar rebotes del botón
    time.sleep(1)

    # Mata la aplicación twinkle-console
    print("Matando la aplicación twinkle-console...")
